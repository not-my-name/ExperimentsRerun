...
public class NoveltyTrainer extends NoveltyEAExtension implements MLTrain {
	 ...
	 */
	public NoveltyTrainer(Population thePopulation, CalculateScore theScoreFunction) {
	 ...
	 */
	public NoveltyTrainer(Population thePopulation, MLDataSet trainingData) {
